  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-20">
        ...
        {/* 8. Team Leadership - The Visionaries Screenshot Sync */}
        <section className="py-20 md:py-32 bg-white relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center mb-16 md:mb-24">
              <h2 className="text-3xl md:text-4xl font-headline font-black text-primary mb-4">
                The Visionaries
              </h2>
              <p className="text-slate-600 font-medium text-sm md:text-base max-w-2xl mx-auto">
                The kingpins of the real estate industry and a luminary for the rising young talent.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8">
              {[
                { 
                  ...
                  image: "https://investorsclinic.in/img/leadership/honey-katiyal.jpg" 
                },
                { 
                  name: "Sakshee Katiyal", 
                  role: "COO", 
                  image: "https://investorsclinic.in/img/leadership/sakshi-katiyal.jpg" 
                },
                { 
                  name: "Sunny Katiyal", 
                  role: "Co-founder & Managing Director", 
                  image: "https://investorsclinic.in/img/leadership/sunny-katiyal.jpg" 
                },
                { 
                  name: "Bhawna Katiyal", 
                  role: "President HR", 
                  image: "https://investorsclinic.in/img/leadership/bhawna-katiyal.jpg" 
                }
              ].map((founder, i) => (
                <motion.div 
                  key={i} 
                ...
                >
                  {/* Oval/Egg Container Styling */}
                  <div className="relative w-full aspect-[4/5] max-w-[280px] mb-8">
                    <div className="absolute inset-0 rounded-[50%_50%_50%_50%_/_60%_60%_40%_40%] border-2 border-primary/40 group-hover:border-secondary transition-colors duration-500 overflow-hidden bg-slate-50 flex items-center justify-center">
                      <img 
                        src={founder.image} 
                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
                        alt={founder.name}
                        onError={(e) => {
                          (e.target as HTMLImageElement).src = `https://i.pravatar.cc/400?u=${founder.name}`;
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="text-center space-y-1">
                    <h4 className="text-xl md:text-2xl font-black text-primary tracking-tight group-hover:text-secondary transition-colors leading-none">
                      {founder.name}
                    </h4>
                    <p className="text-primary/70 font-bold text-[13px] md:text-[14px]">
                      ( {founder.role} )
                    </p>
                  </div>
                </motion.div>
