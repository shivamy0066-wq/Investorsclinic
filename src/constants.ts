...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "heading", text: "What are Studio Apartments? (Meaning)" },
      ...
      { type: "heading", text: "Types of Studio Apartments" },
      ...
      { type: "paragraph", text: "• Standard Studio Apartment → A simple open-plan unit with living, sleeping, and kitchen space combined, plus a separate bathroom." },
      { type: "paragraph", text: "• Alcove Studio Apartment → Designed with a small corner or niche for the bed, giving slightly more privacy within the same space." },
      { type: "paragraph", text: "• Convertible Studio Apartment → Comes with flexible layouts like sliding doors or partitions to create separate areas when needed." },
      { type: "paragraph", text: "• Micro Studio Apartment → Very compact units designed for affordability, ideal for students and single professionals." },
      { type: "paragraph", text: "• Luxury Studio Apartment → Premium studios in modern projects with better interiors, amenities, and smart home features." },
      { type: "heading", text: "Structure & Layout of Studio Apartments" },
      ...
      { type: "heading", text: "Sizes of Studio Apartments" },
      ...
      { type: "paragraph", text: "• Micro studio apartments → 250–350 sq. ft., ideal for students and single professionals looking for budget-friendly options" },
      { type: "paragraph", text: "• Standard studio apartments → 350–500 sq. ft., offering a balanced mix of comfort and usability" },
      { type: "paragraph", text: "• Premium studio apartments → 500–650+ sq. ft., available in modern and luxury projects with better layouts and amenities" },
      ...
      { type: "heading", text: "Key Features of Studio Apartments" },
      ...
      { type: "heading", text: "Advantages of Studio Apartments" },
      ...
      { type: "heading", text: "Studio Apartment vs Normal Apartment" },
      ...
      { type: "heading", text: "Investment Benefits of Studio Apartments" },
      ...
      { type: "heading", text: "Who Should Buy Studio Apartments?" },
      ...
      { type: "heading", text: "Things to Consider Before Buying" },
      ...
      { type: "paragraph", text: "What is the difference between a studio apartment and a 1BHK?" },
      ...
      { type: "paragraph", text: "Are studio apartments easy to maintain?" },
      ...
      { type: "paragraph", text: "What should I check before buying a studio apartment?" },
      ...
      { type: "paragraph", text: "Why are studio apartments becoming popular?" },
